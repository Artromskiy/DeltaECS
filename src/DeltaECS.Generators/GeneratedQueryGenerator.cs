...
public sealed class GeneratedQueryGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterSourceOutput(
            GeneratorPipeline.ShapeProvider<QueryShape>(
                    context,
                ...
                .Collect(),
            static (productionContext, shapes) => GeneratorPipeline.EmitShapes<QueryShape>(
                shapes,
                productionContext,
                "GeneratedQuery_",
        ...
        internal QueryShape(string kind, int arity)
        {
            ...
            Api = new ApiShape(
                ...
                new SelectorSpec(
                    ...
                    GeneratorSupport.ComponentSlots(arity, SelectorKind.Generic, AccessKind.RowRead)),
