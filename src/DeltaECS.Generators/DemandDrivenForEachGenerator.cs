...
public sealed class DemandDrivenForEachGenerator : IIncrementalGenerator
{
    ...
    private const string GeneratedSourceHeader = """
        // <auto-generated />
        #nullable enable
        using System;
        namespace Delta.ECS
    ...
    {
        StringBuilder source = GeneratorSupport.CreateSource(32 * 1024, GeneratedSourceHeader);
    ...
    private static void AppendInvokerFields(StringBuilder source, Shape shape, string actionType)
    {
        if (shape.HasContext)
        {
    ...
    private static void AppendInvokerProperties(StringBuilder source, Shape shape)
    {
        if (shape.HasContext)
        {
    ...
    private static void AppendParallelWriteIndices(StringBuilder source, Shape shape)
    {
    ...
    {
        StringBuilder source = GeneratorSupport.CreateSource(16 * 1024, InterceptorSourceHeader);
    ...
    private static void AppendQueryComponentRoutes(StringBuilder source, Shape shape, string indent)
    {
    ...
    private static string InvokerName(Shape shape) => "DemandForEachInvoker_" + GeneratorSupport.StableName(shape.Key);

    private static string ParallelInvokerName(Shape shape)
