...
public sealed class GeneratedStructuralGenerator : IIncrementalGenerator
{
    ...
    private static string Render(StructuralModel shape)
    {
        RenderModel member = GeneratorTemplates.ExtensionTemplate(
            shape.Api,
            "GeneratedStructuralExtensions_" + GeneratorSupport.StableName(shape.Key),
            isInternal: false,
            source =>
        {
    ...
    private static void AppendComponents(StringBuilder source, StructuralModel shape)
    {
    ...
    private sealed class StructuralModel
    {
