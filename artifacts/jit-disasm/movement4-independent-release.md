...
- First emitted code block: **1412 B**
- Reconstructed ARM64 instruction span: **1412 B**
...
BenchmarkDotNet `--job default`, one sequential run for the current branch,
with `Amount` values 100, 1000, 10000 and 100000. Mean is arithmetic mean;
Allocated is managed allocation per operation.

| Amount | Mean | Allocated |
|---:|---:|---:|
| 100 | 371.5 ns | 736 B |
| 1000 | 2,869.3 ns | 736 B |
| 10000 | 27,141.8 ns | 736 B |
| 100000 | 241,398.0 ns | 736 B |
