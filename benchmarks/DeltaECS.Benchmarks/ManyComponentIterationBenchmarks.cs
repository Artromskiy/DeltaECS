...
public class ManyComponentIterationBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _components =
        [
            layouts.Register<Movement4A>( new SchemaId(203_000)),
            layouts.Register<Movement4B>( new SchemaId(203_001)),
            layouts.Register<Movement4C>( new SchemaId(203_002)),
            layouts.Register<Movement4D>( new SchemaId(203_003)),
            layouts.Register<Many16_0>( new SchemaId(203_004)),
            layouts.Register<Many16_1>( new SchemaId(203_005)),
            layouts.Register<Many16_2>( new SchemaId(203_006)),
            layouts.Register<Many16_3>( new SchemaId(203_007)),
            layouts.Register<Many16_4>( new SchemaId(203_008)),
            layouts.Register<Many16_5>( new SchemaId(203_009)),
            layouts.Register<Many16_6>( new SchemaId(203_010)),
            layouts.Register<Many16_7>( new SchemaId(203_011)),
            layouts.Register<Many16_8>( new SchemaId(203_012)),
            layouts.Register<Many16_9>( new SchemaId(203_013)),
            layouts.Register<Many16_10>( new SchemaId(203_014)),
            layouts.Register<Many16_11>( new SchemaId(203_015)),
            layouts.Register<Many16_12>( new SchemaId(203_016)),
            layouts.Register<Many16_13>( new SchemaId(203_017)),
            layouts.Register<Many16_14>( new SchemaId(203_018)),
            layouts.Register<Many16_15>( new SchemaId(203_019)),
            layouts.Register<Many4A_0>( new SchemaId(203_020)),
            layouts.Register<Many4A_1>( new SchemaId(203_021)),
            layouts.Register<Many4A_2>( new SchemaId(203_022)),
            layouts.Register<Many4A_3>( new SchemaId(203_023)),
            layouts.Register<Many4B_0>( new SchemaId(203_024)),
            layouts.Register<Many4B_1>( new SchemaId(203_025)),
            layouts.Register<Many4B_2>( new SchemaId(203_026)),
            layouts.Register<Many4B_3>( new SchemaId(203_027)),
            layouts.Register<Many4C_0>( new SchemaId(203_028)),
            layouts.Register<Many4C_1>( new SchemaId(203_029)),
            layouts.Register<Many4C_2>( new SchemaId(203_030)),
            layouts.Register<Many4C_3>( new SchemaId(203_031)),
        ];
