...
public partial class ComparativeStructuralListBenchmarks
{
    ...
    private void RestoreBase() { switch (_state) { case ListState.Created: _world.Destroy(_created); break; case ListState.Destroyed: _world.Create(_base, _entities); break; case ListState.Added: _world.RemoveComponents(_activeChange, _entities); break; } _state = ListState.Base; }
