...
#pragma warning disable CS0436 // Demand-generated callback contracts can also arrive through a referenced consumer assembly.
    ...
    static class ForEachInterceptor_93F8499C2EBE48E9D
    {
        [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
        public static void ExecuteInterceptedClosed_93F8499C2EBE48E9(global::Delta.ECS.World world, in global::Delta.ECS.Query query, ref global::Delta.ECS.IterationProbe.IterationBenchmarks.IterationState context)
        {
            global::Delta.ECS.IterationProbe.IterationBenchmarks.IterationState state = context;
            using var execution = GeneratedForEachRuntime.OpenBoundDenseRead<global::Delta.ECS.DemandForEachExtensions_68269C47413FA73B.DenseBinding, global::Delta.ECS.DemandForEachExtensions_68269C47413FA73B.DenseRows>(world, in query);
            int chunkCount = execution.Rows.Length;
            ref var batchCursor = ref global::System.Runtime.InteropServices.MemoryMarshal.GetReference(execution.Rows);
            ref global::Delta.ECS.IterationProbe.First row = ref global::System.Runtime.CompilerServices.Unsafe.NullRef<global::Delta.ECS.IterationProbe.First>();
            for (int chunk = 0; chunk < chunkCount; chunk++)
            {
                var batch = batchCursor;
                int count = batch.Chunk.Count;
                row = ref GeneratedForEachRuntime.GetGeneratedArrayReference(batch.Row0);
                for (int index = 0; index < count; index++)
                {
                    ref readonly global::Delta.ECS.IterationProbe.First first = ref row;
                    {
                        state.Visited++;
                        state.Checksum += first.Value;
                    }

                    row = ref global::System.Runtime.CompilerServices.Unsafe.Add(ref row, 1);
                }

                batchCursor = ref global::System.Runtime.CompilerServices.Unsafe.Add(ref batchCursor, 1);
            }
        ...
        internal static void Intercept_93F8499C2EBE48E9(this global::Delta.ECS.World world, in global::Delta.ECS.Query query, ref global::Delta.ECS.IterationProbe.IterationBenchmarks.IterationState context, global::Delta.ECS.ForEachContextAction_I<global::Delta.ECS.IterationProbe.IterationBenchmarks.IterationState, global::Delta.ECS.IterationProbe.First> _)
        {
            ExecuteInterceptedClosed_93F8499C2EBE48E9(world, in query, ref context);
        }
    }
}
...
{
    sealed class InterceptsLocationAttribute : global::System.Attribute
    {
