...
public class EntityRecordResolveMicroBenchmarkImplementation
{
...
public class CreateKnownArchetypeMicroBenchmarkImplementation
{
...
public class CachedBindingIterationMicroBenchmarkImplementation
{
...
public class AtomicStructuralMicroBenchmarkImplementation
{
...
public class ListBatchMicroBenchmarkImplementation
{
...
public class QueryBatchMicroBenchmarkImplementation
{
    [Params(100, 1_000, 10_000)] public int Amount { get; set; }
    private MicroWorld _fixture = null!;
...
public class StorageAndOverlayMicroBenchmarkImplementation
{
